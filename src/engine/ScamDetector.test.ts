...
const SCAMS: Case[] = [
  ...
  ['BBVA: su cuenta sera suspendida hoy. Verifique inmediatamente aqui: bbva-seguro-verificar.co/x2','spanish-bank'],
  ['Banamex: actividad inusual. Ingrese sus datos para evitar el bloqueo de su cuenta: acceso-banamex.top','spanish-bank'],
  ['Felicidades! Ha ganado un premio de la loteria. Reclame su premio hoy mismo.','spanish-prize'],
  ['Su paquete esta retenido en aduana. Pague la tarifa de $2.50 aqui: correos-entrega.info','spanish-package'],
  ['Comparta el codigo de verificacion que le enviamos para desbloquear su cuenta.','spanish-otp'],
  ['Votre compte sera suspendu. Verifiez votre identite ici: compte-securise-verif.info','french-bank'],
  ['Votre colis est retenu. Payez les frais de douane ici: livraison-colis-frais.top','french-package'],
  ['Caixa: sua conta sera bloqueada hoje. Verifique sua identidade: caixa-seguro-acesso.top','portuguese-bank'],
...
const LEGIT: Case[] = [
  ...
  ['Hola mama, llego 15 minutos tarde a la cena. Nos vemos pronto!','spanish-family'],
  ['Recordatorio: su cita con la Dra. Gomez es el martes a las 3pm.','spanish-appointment'],
  ['Ta commande est prete, tu peux venir la chercher a la boulangerie.','french-family'],
