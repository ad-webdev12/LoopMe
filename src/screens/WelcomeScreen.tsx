...
const s = StyleSheet.create({
  ...
  tagline: { fontSize: T.body, color: T.inkSoft, textAlign: 'center', lineHeight: 28, marginTop: 10, marginBottom: 18 },
  choice: { padding: 20 },
  choiceTitle: { fontSize: T.bodyLg, fontWeight: '800', color: T.ink, marginTop: 10 },
  choiceBody: { fontSize: T.small, color: T.inkSoft, lineHeight: 25, marginTop: 6, marginBottom: 8 },
  title: { fontSize: T.headline, fontWeight: '800', color: T.ink, textAlign: 'center', letterSpacing: -0.4 },
  sub: { fontSize: T.body, color: T.inkSoft, textAlign: 'center', lineHeight: 28, marginVertical: 14 },
});
